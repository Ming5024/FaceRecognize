...
public:
	...
	// 设置最小化图标;
	void setMinIcon(QString filePath, QSize IconSize = QSize(25, 25));
	// 设置最大化图标;
	void setMaxIcon(QString filePath, QSize IconSize = QSize(25, 25));
	// 设置恢复图标;
	void setRestoreIcon(QString filePath, QSize IconSize = QSize(25, 25));
	// 设置关闭图标;
	void setCloseIcon(QString filePath, QSize IconSize = QSize(25, 25));
